...
class App {
  ...
  _renderWorkout(workout) {
    ...
    <li class="workout workout--${workout.type}" data-id="${workout.id}">
          ...
          <div class="workout__close" data-id="${workout.id}">X</div>
  ...
  closeWorkoutElement() {
    document.querySelectorAll('.workout__close').forEach(workoutElement => {
      workoutElement.addEventListener('click', event => {
